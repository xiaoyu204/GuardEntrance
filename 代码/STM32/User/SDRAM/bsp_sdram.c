...
void SDRAM_Init(void)
{
    ...
    /*
        ...
        （这里的150MHZ不是FMC的时钟频率！！！！是SDRAM的时钟频率）
      = 64000(64 ms) / 8192 * temp2 MHz - 20
    */
    float temp2 = 175;
    HAL_SDRAM_ProgramRefreshRate(&hsdram1, (64000 * temp2 / 2 / 8192 - 20));
    printf("SDRAM Refresh Rate = %d\r\n", (uint16_t)(64000 * temp2 / 2 / 8192 - 20));
}
